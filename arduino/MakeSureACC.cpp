 ...
 * It opens I2C bus and powers the accelerometer
 */
void MakeSureACC::ON(uint8_t FS_OPTION)
{	
 ...
 */
uint8_t MakeSureACC::getStatus(void)
{
 ...
 */
uint8_t MakeSureACC::check(void)
{
 ...
 */
uint8_t MakeSureACC::getCTRL1(void)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setCTRL1(uint8_t val)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::getCTRL2(void)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setCTRL2(uint8_t val)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::getCTRL3(void)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setCTRL3(uint8_t val)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::getCTRL4(void)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setCTRL4(uint8_t val)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::getCTRL5(void)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setCTRL5(uint8_t val)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setSamplingRate(uint8_t rate)
{
 ...
 */
uint8_t MakeSureACC::getINT1CFG(void)
{
 ...
 */
uint8_t MakeSureACC::getINT1SRC(void)
{
 ...
 */
uint8_t MakeSureACC::getINT1THS(void)
{
 ...
 */
uint8_t MakeSureACC::getINT1DURATION(void)
{
 ...
 * was an error communicating to the register
 */
uint8_t MakeSureACC::setMode(uint8_t mode)
{
	accMode = mode;
 ...
 * 
 */
uint8_t MakeSureACC::setSleepToWake(void)
{
 ...
 * 
 */
uint8_t MakeSureACC::unSetSleepToWake(void)
{
...
/*******************************************************************************
 * SPECIFIC MakeSure FUNCTIONS TO HANDLE EVENTS
 ******************************************************************************/

/*
 * setFF (void) - sets the Free Fall interrupt
 */
uint8_t MakeSureACC::setFF(void)
{
 ...
 */
uint8_t MakeSureACC::unsetFF(void)
{
 ...
 */
uint8_t MakeSureACC::unsetIWU(void)
{
	// set CTRL_REG3 to zero
	writeRegister(CTRL_REG3, 0x00);  
 ...
 */
uint8_t MakeSureACC::set6DMovement(void)
{
	// clear the FF interrupt if active
	unset6DMovement();
 ...
 */
uint8_t MakeSureACC::unset6DMovement(void)
{
	// set CTRL_REG3 to zero
	writeRegister(CTRL_REG3, 0x00);  
 ...
 * unset6DPosition (void) - clears and unsets the Inertial Wake-UP interrupt
 */
uint8_t MakeSureACC::unset6DPosition(void)
{
	// set CTRL_REG3 to zero
	writeRegister(CTRL_REG3, 0x00);
 ...
 */
void MakeSureACC::attachInt(void)
{
	enableInterrupts(ACC_INT);
}
 ...
 */
void MakeSureACC::detachInt(void)
{
 ...
 */
/*void MakeSureACC::clearAlarmFlag(void)
{
...
int16_t MakeSureACC::readRegister(uint8_t regNum) 
{
	// reset the flag
...
uint8_t MakeSureACC::writeRegister(uint8_t address, uint8_t val)
{
	// reset the flag
