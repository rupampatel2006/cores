...
/*! \def MakeSureXBeeCore_h
    \brief The library flag
    
 */
#ifndef MakeSureXBeeCore_h
#define MakeSureXBeeCore_h
...
//! Variable :  MakeSuremote serial id
/*!
*/ 
 ...
 ******************************************************************************/
 ...
 //! MakeSureXBeeCore Class
/*!
	MakeSureXBeeCore Class defines all the variables and functions used for managing 
	the XBee modules. In this library, all the common functions are defined to 
	be used in the other XBee libraries
 */
class MakeSureXBeeCore
{
